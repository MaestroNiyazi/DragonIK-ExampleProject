...
#include "UnrealWidget.EditMode.Fix.Neb.h" //Neb "UnrealWidget.h"
...
public:
	...
	virtual EWidgetMode GetWidgetMode() const override; //Neb
	virtual EWidgetMode ChangeToNextWidgetMode(EWidgetMode CurWidgetMode) override; //Neb
	virtual bool SetWidgetMode(EWidgetMode InWidgetMode) override; //Neb
