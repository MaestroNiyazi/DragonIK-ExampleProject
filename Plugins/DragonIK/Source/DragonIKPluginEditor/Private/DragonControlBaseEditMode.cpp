...
/*FWidget::*/EWidgetMode FDragonControlBaseEditMode::GetWidgetMode() const //Neb
{
	UAnimGraphNode_DragonControlBase* SkelControl = Cast<UAnimGraphNode_DragonControlBase>(AnimNode);
	if (SkelControl != nullptr)
	{
	...
	return /*FWidget::*/EWidgetMode::WM_None; //Neb
}

/*FWidget::*/EWidgetMode FDragonControlBaseEditMode::ChangeToNextWidgetMode(/*FWidget::*/EWidgetMode CurWidgetMode) //Neb
{
	UAnimGraphNode_DragonControlBase* SkelControl = Cast<UAnimGraphNode_DragonControlBase>(AnimNode);
	if (SkelControl != nullptr)
	{
...
bool FDragonControlBaseEditMode::SetWidgetMode(/*FWidget::*/EWidgetMode InWidgetMode) //Neb
{
	UAnimGraphNode_DragonControlBase* SkelControl = Cast<UAnimGraphNode_DragonControlBase>(AnimNode);
	if (SkelControl != nullptr)
	{
...
bool FDragonControlBaseEditMode::InputKey(FEditorViewportClient* InViewportClient, FViewport* InViewport, FKey InKey, EInputEvent InEvent)
{
	...
	{
		/*FWidget::*/EWidgetMode WidgetMode = (/*FWidget::*/EWidgetMode)ChangeToNextWidgetMode(GetModeManager()->GetWidgetMode()); //Neb
		GetModeManager()->SetWidgetMode(WidgetMode);
		if (WidgetMode == /*FWidget::*/EWidgetMode::WM_Scale) //Neb
		{
...
bool FDragonControlBaseEditMode::InputDelta(FEditorViewportClient* InViewportClient, FViewport* InViewport, FVector& InDrag, FRotator& InRot, FVector& InScale)
{
	...
	const /*FWidget::*/EWidgetMode WidgetMode = InViewportClient->GetWidgetMode(); //Neb
	...
	if (bManipulating && CurrentAxis != EAxisList::None)
	{
		...
		const bool bDoRotation = WidgetMode == /*FWidget::*/EWidgetMode::WM_Rotate || WidgetMode == /*FWidget::*/EWidgetMode::WM_TranslateRotateZ; //Neb
		const bool bDoTranslation = WidgetMode == /*FWidget::*/EWidgetMode::WM_Translate || WidgetMode == /*FWidget::*/EWidgetMode::WM_TranslateRotateZ; //Neb
		const bool bDoScale = WidgetMode == /*FWidget::*/EWidgetMode::WM_Scale; //Neb
